...
<head>
    ...
    <title>Account Settings - Water quality</title>
    ...
    <div class="container"><img width="197" height="111" src="assets/img/brands/Water%20quality.svg"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="registrati.html"></a></li>
            </ul><a class="btn btn-primary shadow" role="button" href="registrati.php">Registrati</a>
        </div>
        <div></div>
    </div>
</nav>
                        ...
                        <div class="account-settings">
                            <div class="user-profile">
                                <div class="user-avatar">
                                    <img src="assets/img/illustrations/avatar.svg" alt="User Avatar">
                                </div>
                                <h5 class="user-name" id="display-name">Nome Utente</h5>
                                <h6 class="user-email" id="display-email">email@dominio.com</h6>
                            </div>
                            <div class="about"></div>
                        </div>
                    </div>
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="fullName" placeholder="Inserisci nuovo nome" required>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="eMail">Email</label>
                                    <input type="email" class="form-control" id="eMail" placeholder="Inserisci nuova email" required>
                                </div>
                            </div>
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password" placeholder="Inserisci nuova Password" required>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12"></div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12"></div>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-right">
                                    <button type="button" id="update" name="update" class="btn btn-primary">Aggiorna</button>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        fetch('fetch_user_data.php')
            ...
            .then(data => {
                console.log(data); // Aggiungi un log per verificare i dati
                document.getElementById('display-name').innerText = data.Nome || 'Nome Utente';
                document.getElementById('display-email').innerText = data.Email || 'email@dominio.com';
        ...
        document.getElementById('update').addEventListener('click', function () {
            ...
            if (!nome || !email || !password) {
                alert('Tutti i campi sono obbligatori.');  // altrimenti qualcuno può inserire una password vuota
                return;
            }

            if (password.length < 8) {
                alert('La password deve avere lunga almeno 8 caratteri.');
                return;
            }
