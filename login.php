...
// Imposta i cookie
        setcookie('user_id', $user['ID_Utente'], time() + (86400 * 30), "/");
        setcookie('user_role', $user['Ruolo'], time() + (86400 * 30), "/");

// Redirezione alla dashboard appropriata
        if ($user['Ruolo'] == 'admin') {
...
<head>
    ...
    <title>Log in - Water quality</title>
    <link rel="icon" type="image/png" sizes="500x500" href="assets/img/favicon.png">
    <link rel="icon" type="image/png" sizes="500x500" href="assets/img/favicon.png" media="(prefers-color-scheme: dark)">
    <link rel="icon" type="image/png" sizes="500x500" href="assets/img/favicon.png">
    <link rel="icon" type="image/png" sizes="500x500" href="assets/img/favicon.png" media="(prefers-color-scheme: dark)">
    <link rel="icon" type="image/png" sizes="500x500" href="assets/img/favicon.png">
    <link rel="icon" type="image/png" sizes="500x500" href="assets/img/favicon.png">
    ...
    <div class="container py-md-5">
        <div class="row">
            ...
            <div class="col-md-5 col-xl-4 text-center text-md-start">
                ...
                <p class="text-muted"><a href="password-dimenticata.php">Password dimenticata?</a></p>
            </div>
        </div>
    </div>
</section>
